...
from cosmos_predict2._src.predict2.inpainting.networks.inpainting_dit import (
    InpaintingConcatMinimalV1LVGDiT,
)
...
COSMOS_V1_7B_NET_MININET: LazyDict = L(InpaintingConcatMinimalV1LVGDiT)(
    max_img_h=240,
    max_img_w=240,
    max_frames=128,
    in_channels=16,
...
COSMOS_V1_2B_NET_MININET.in_channels = 36     # 16+16+4
...
def register_net():
    ...
    cs.store(
        group="net", package="model.config.net", name="cosmos_v1_2B_inpainting_concat", node=COSMOS_V1_2B_NET_MININET
    )
    # cs.store(
    #     group="net", package="model.config.net", name="cosmos_v1_7B_inpainting_concat", node=COSMOS_V1_7B_NET_MININET
    # )
