...
from cosmos_predict2._src.predict2.action_parallel_predict.configs.action_cogeneration.callbacks import register_callbacks
from cosmos_predict2._src.predict2.action_parallel_predict.configs.action_cogeneration.conditioner import register_conditioner
from cosmos_predict2._src.predict2.action_parallel_predict.configs.action_cogeneration.data import register_training_and_val_data
from cosmos_predict2._src.predict2.action_parallel_predict.configs.action_cogeneration.net import register_net
from cosmos_predict2._src.predict2.action_parallel_predict.configs.action_cogeneration.model import register_model
...
def make_config() -> Config:
    ...
    c.trainer.straggler_detection.enabled = False           # 禁用掉队检测（用于多GPU训练中检测慢节点）-> Nvidia internal pkg
