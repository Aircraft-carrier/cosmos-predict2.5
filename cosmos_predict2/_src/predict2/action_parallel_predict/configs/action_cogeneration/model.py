...
from cosmos_predict2._src.predict2.action_parallel_predict.models.action_generation_video2world_rectified_flow_model import (
...
from cosmos_predict2._src.predict2.action_parallel_predict.models.video2world_model_rectified_flow import Video2WorldModelRectifiedFlow

FSDP_RECTIFIED_FLOW_CONFIG1 = dict(
    trainer=dict(
        distributed_parallelism="fsdp",
    ),
...
def register_model():
    ...
    cs.store(
        group="model",
        package="_global_",
        name="action_generation_video2world_fsdp_rectified_flow",
        node=FSDP_RECTIFIED_FLOW_CONFIG,
    )
    cs.store(
        group="model",
        package="_global_",
        name="video2world_fsdp_rectified_flow_libero",
        node=FSDP_RECTIFIED_FLOW_CONFIG1,
    )
