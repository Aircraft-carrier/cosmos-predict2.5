...
class CallBackGroup:
    ...
    def __getattr__(self, method_name: str) -> Callable:
        ...
        def multi_callback_wrapper(*args, **kwargs) -> None:
            # self._callbacks的遍历顺序和定义一致 LINK cosmos_predict2/_src/predict2/configs/video2world/experiment/reason_embeddings/model_2B_reason_1p1_rectified_flow.py:274 
            # 即先basic，再viz_online_sampling，再wandb，再cluster_speed
            # basic的顺序也是和定义一致 LINK cosmos_predict2/_src/predict2/configs/common/defaults/callbacks.py:28
