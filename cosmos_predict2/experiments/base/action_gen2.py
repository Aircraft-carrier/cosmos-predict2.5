...
ac_gen_reason_embeddings_rectified_flow_2b_256_320 = LazyDict(
    dict(
        defaults=[
            DEFAULT_CHECKPOINT.experiment,
            {"override /model": "action_generation_video2world_fsdp_rectified_flow"},
            {"override /net": "cosmos_2_v1_2B_action_generation"},
        ...
        job=dict(
            ...
            name="2b_libero_action_congeneratioin",
        ),
        optimizer=dict(
            lr=2 ** (-14.5),  
            weight_decay=0.1,
...
for _item in [ac_gen_reason_embeddings_rectified_flow_2b_256_320]:
