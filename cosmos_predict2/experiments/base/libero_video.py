...
reason_embeddings_rectified_flow_libero = LazyDict(
    dict(
        defaults=[
            DEFAULT_CHECKPOINT.experiment,
            {"override /model": "video2world_fsdp_rectified_flow_libero"},
...
for _item in [reason_embeddings_rectified_flow_libero]:
